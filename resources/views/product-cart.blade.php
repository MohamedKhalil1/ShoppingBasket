<div class="container py-3">
    <div class="card">
      	<div class="row ">
	        <div class="col-md-4">
            	<img class="product-details-image col-md-5 w-100" src="../storage/app/{{ $product->productimage }}">
	        </div>
        	...
        	<div class="col-md-8 px-3">
	            <div class="card-block px-3">
				  ...
				  <p class="details">Availability: Yes</p>

	            </div>

	            <div class="form">
		          	<form class="form-inline">
	                	<label class="mr-sm-2" for="quantity-select">Stock Quantity: {{$product->stockquantity}}</label>
				...
				<div class="footer-card">   
				    ...
				    <form>
				  		<a style="padding-left: 10px;" href="{{url('cart/delete/'. $product->id)}}" data-method="delete" data-delete="{{ $product->id }}" type="hidden" name="_method" >Delete</a>
				    </form>   
			    </div>
			</div>	
		</div>
