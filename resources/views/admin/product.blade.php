...
<html lang="en">
   ...
   <body>
      ...
      <div class="container">
         ...
         <div class="row mt-20">
            <div class="col-md-12">
               <table class="table table-striped" id="productsTable" style="border-collapse:collapse;" >
                  <thead>
                     <tr>
                        <th>Id</th>
                        <th>Name</th>
      ...
      <div class="modal fade mt-50" id="add-product-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               <form method="POST" action="{{url('/admin/products/add')}}" id="add-product" enctype="multipart/form-data">
